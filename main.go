...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		vaultCname, err := common.NewDnsRecord(ctx, "vault-dns", "vault2", "galaxygridlabs-com", "CNAME", cloudRunDns)
		if err != nil {
			return err
		}
		...
		gitDns, err := common.NewDnsRecord(ctx, "gitea-dns", "git", "galaxygridlabs-com", "A", tmp)
		if err != nil {
			return err
		}
